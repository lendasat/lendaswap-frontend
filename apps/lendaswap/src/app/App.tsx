...
import {Shield, PiggyBank, Zap, Tag} from "lucide-react";
...
import {SwapSendPage, SwapProcessingPage, SwapSuccessPage} from "./pages";
...
function HomePage() {
    ...
    const handleContinueToAddress = async () => {
        ...
        try {
            ...
            const {publicKey: refund_pk} = getOrCreateBitcoinKeys();
            ...
            // Store the secret in browser storage under the swap ID
            localStorage.setItem(swap.id, JSON.stringify({secret}));
